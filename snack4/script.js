...
for(var player of team){
  ...
  player.perc = getRandomNumber(0, 50);
}
console.log(team)
...
//ESERCIZIO CON ECMA 6 SCRIPT

const team = [{name:'Ugo'},{name:'Giuseppe'},{name:'Mario'},{name:'Marco'},{name:'Filippo'}];
...
for(let player of team){
  ...
  player.perc = (min,max) => Math.floor(Math.random()*(max-min+1)+min);
